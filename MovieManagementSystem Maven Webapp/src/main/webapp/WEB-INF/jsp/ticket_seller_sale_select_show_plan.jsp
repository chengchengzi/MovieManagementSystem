	...
	<div id="content">
		...
		<div class="show-date">
  			...
  			<c:forEach items="${listShowPlanFilmTime}" var="listShowPlanFilmTime" varStatus="status">
   			<a  
   			href="${pageContext.request.contextPath}/TicketSeller/selectShowPlanByA?film_id=${listFilmInfo.film_id}&date=${listShowPlanFilmTime.show_time}"
  		...
  		<div class="plist-container active">
			...
			<table class="plist">
    			...
    			<tr class="">
      				...
      				<td>
        				<a href="${pageContext.request.contextPath}/TicketSeller/selectSeat?film_id=${listFilmInfo.film_id}&show_plan_id=${listShowPlanInfo.show_plan_id}" 
