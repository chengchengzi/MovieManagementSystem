...
<script type="text/javascript">
	//保存座位信息
    function save(){
       window.location.href="${pageContext.request.contextPath}/AdminMain/saveSeat?seat_selected=" 
 ...
 <!-- 延迟1秒后，跳转 -->
  	<script type="text/javascript">
 		var myDelay = setTimeout(function(){
 			window.location.href="${pageContext.request.contextPath}/AdminMain/showFilmInfo";
 		},1000);
 	</script>
 <%
